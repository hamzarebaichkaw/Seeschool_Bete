  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 50 }}>
        ...
        <br />
        <br />
        <h2 style={{ textAlign: 'center', marginBottom: 30 }}  > {show ? "Liste des Étudiants" : "Choisissez une classe"} </h2>
        {tableLoading ?
          ...
          show ?
            <Grid container spacing={4}>
              <Grid item xs={12}>
                <MUIDataTable
                  title="List Étudiants"
                  data={mat}
                  columns={["ID", "Nom et prénom", "Lieu", "date de naissance", "Class"]}
                  options={{
                    filterType: "checkbox",
                    textLabels: {
                      body: {
