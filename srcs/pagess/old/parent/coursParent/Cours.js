  ...
  {    
           ...
           CoursM.map(
             ...
             (m)=>( 
               ...
               <FolderBlue  title={m.matieress }label="" value= "165 files"   />
...
const Exercice = () =>
<div style={{display:'flex',justifyContent:'center' }} >
<FolderRed title="Python" label="Numpy" value={'Exercice'} />
<FolderRed title="C++" label="Loops" value={'Exercice'} />
      </div>
...
<div>
 ...
 <div style={{backgroundColor:'',}}>
         ...
         <div  >
          ...
          < FolderBlue  title="Matiere"label="" value=   { ''}   />
          </IconButton>  
          ...
          <FolderRed title="Exercices" label="" value={''} />
          </IconButton>  
           </div>
           <br />
           {/* {
...
CoursM.map(
  ...
  (m)=>( 
       ...
       {ShowexErcice ? <Exercice /> : null}
         ...
         <br />
         <br />
         <h2 style={{textAlign:'center',backgroundColor:'#3a86ff',border:'solid', color:'white',borderRadius:20}}  >Vérifier les cours des étudiant </h2>
         {/* <Widget
            title="LESSONS"
            noBodyPadding
