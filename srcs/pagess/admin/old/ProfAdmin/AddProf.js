...
//Affichage de la redirection
  ...
  <p style={{color:"red",fontSize:12,display:displaynom}} >NAME IS NEEDED</p>
            ...
            helperText=""
        />
        <p style={{color:"red",fontSize:12,display:displayuser}} >username IS NEEDED</p>
                                 <TextField
            id="outlined-basic"
            ...
            type={'textera'}
        />
        <p style={{color:"red",fontSize:12,display:displayemail}} >email IS NEEDED</p>
                                    <TextField
            id="outlined-basic"
            label="E-mail"
            // onChange={}
            ...
            type={'textera'}
        />
        <p style={{color:"red",fontSize:12,display:displayphone}} >NAME IS NEEDED</p>
                <TextField
                    id="outlined-basic"
        ...
        <p style={{color:"red",fontSize:12,display:displaygenre}} >genre IS NEEDED</p>
        <Select
       ...
       <p style={{color:"red",fontSize:12,display:displaydate}} >genre IS NEEDED</p>
  ...
  <br />
  <br />
  <p style={{color:"red",fontSize:12,display:displaynat}} >NAME IS NEEDED</p>
                 <TextField
            id="outlined-basic"
            label="Nationalite"
        ...
        />
                            ...
                            <div>
                             ...
                             <p style={{color:"red",fontSize:12,display:displaytype}} >NAME IS NEEDED</p>
                                <Multiselect
                            ...
                            <div>
                             ...
                             <p style={{color:"red",fontSize:12,display:displayniv}} >NAME IS NEEDED</p>
                                <Multiselect
                                style={{ width: 600, height: 20, marginBottom: 80 }}
                                 onSelect={onSelectS}
                                 onRemove={onSelectS}
                            ...
                            <br/>
                                ...
                                <p style={{color:"red",fontSize:12,display:displaymat}} >NAME IS NEEDED</p>
                                <Multiselect
                                style={{ width: 600, height: 20, marginBottom: 80 }}
                                 options={options2}
                                 onSelect={onSelectS2}
                          ...
                          <p style={{color:"red",fontSize:12,display:displaysec}} >NAME IS NEEDED</p>
                          <Select
                        ...
                        <p style={{color:"red",fontSize:12,display:displaydesc}} >NAME IS NEEDED</p>
                                    <TextField
                                        id="outlined-basic"
                                        label="Description"
                                        variant="outlined"
