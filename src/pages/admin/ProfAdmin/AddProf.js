...
const AddProfs = () => {
    ...
    var [password, setpassword] = useState("");
    var [Genre, setGenre] = useState("");
    var [roles, setroles] = useState("Enseignant");
    var [date_naissance, setdate_naissance] = useState("");
    var [Nationalite, setNationalite] = useState("Tunisienne");
    var [idProf, setidProf] = useState("");

    var [phone, setphone] = useState("");
    var [Classe, setClasse] = useState("");
    var [niveau, setniveau] = useState("");
    var [matiere, setmatiere] = useState("");
    var [description, setdescription] = useState("");
    const [nvi,setNiv] = useState([])
    const [types,setTypes] = useState([])
    const [selniv,setselniv] = useState([])
    ...
    function ADDPROF(fullName,username,email,Genre,date_naissance,Nationalite,roles
    ...
    function AddProf(matiere,niveau,Classe,description
          ...
          Axios
              ...
              
              {
                  ...
                  // "phone": phone,
                  "matiere": "public/api/matieres/1",
                  "niveau": niveau,              
                  "Classe": ["/public/api/classes/1", 
                  "/public/api/classes/3",
                  "/public/api/classes/4",
                ],
                  "description":description,
...
//Affichage de la redirection
    ...
    return (
        ...
        />
                                 ...
                                 <TextField
            id="outlined-basic"
            label={ displayuser==="none" ?     "Nom d'utilisateur" : <p style={{color:"red",display:displaynom}} >Nom d'utilisateur</p>}
            // onChange={}
            // value={}
            name="username"
            value={username}
    ...
    id="date"
    label={displaydate==="none" ?     "Date de naissance" :
    <p style={{color:"red",display:displaydate}} >Date de naissance</p>}
    type="date"
  ...
  <br />
        ...
        />
                        ...
                        <div>
                            {displaysec==="none"?  <p style={{ fontSize: 15 }}>Niveau:</p>:
                             <p style={{color:"red",fontSize:15,display:displaysec}} >Niveau:</p>}
                        ...
                        <div>
                            {displaysec==="none"?  <p style={{ fontSize: 15 }}>Numero:</p>:
                             <p style={{color:"red",fontSize:15,display:displaysec}} >Numero:</p>}
                                    ...
                                    {activeStep === 0 ? (
                                        ...
                                        >
                                            <Button
                                                ...
                                                color="primary"
                                                onClick={() => {
                                                 if( verif1(fullName,username,email,phone,Genre,date_naissance,Nationalite)) {
                                                    handleNext();
                                                    {ADDPROF(fullName,username,email,password,Genre,date_naissance,Nationalite,roles)}}
                                                }}
                                            >
                                                Suivant
                                            </Button>
                                        ...
                                        >
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    {AddProf(Classe,niveau,matiere,description)}
                                                    if (activeStep === steps.length - 1)
                                                     { if(verif2(types,selniv,mats,section,description))
                                                      { console.log("h");
                                                     sendNotification();
