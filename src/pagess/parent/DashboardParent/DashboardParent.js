 ...
 export default function DashboardParent(){
   ...
   const getUserById = () => {   
    ...
    const d = localStorage.getItem('user_id')
      ...
      axios      .get(`http://www.pointofsaleseedigitalaency.xyz/public/APIUser/Parents/${d}`)    
  ...
  const getphotos = () => {   
    ...
    axios      .get(`http://www.pointofsaleseedigitalaency.xyz/public/APIUser/ImageByparents/${d}`)   
          ...
          <Grid container spacing={1}>
            <Grid item xs={12} sm={5} md={5} lg={5}>
              <div className={classes.visualProfile}>
                ...
                {/* <a  href="http://localhost:3000/#/parent/child">
                <Chip
                  className={classes.chipMargin}
                  color="secondary"
                  label={"Choix de l'enfant"}
                
                />
                </a> */}
                <br />
                <Button variant="contained" color="secondary" href="http://localhost:3000/#/parent/child">
                Choix de l'enfant
</Button>
              </div>
            </Grid>
