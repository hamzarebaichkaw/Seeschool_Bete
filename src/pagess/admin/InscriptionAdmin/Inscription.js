      ...
      .then(res => {
        ...
        res.data.map(i => {
          arr.push({
            ...
            // emailParent: i.parent[0].emailParent,
            // numTelParent: i.parent[0].numTelParent,
            // numUrgenceParent: i.parent[0].numUrgenceParent
          })
        })
        setStudents(arr)
        setShow(true)
              ...
              <Grid item xs={12}>
                <MUIDataTable
                  ...
                  columns={[
                    ...
                    // { name: 'numTelParent', label: 'Téléphone Parent' },
                    // { name: 'numUrgenceParent', label: 'Téléphone Parent (Urgence)' },
                    // { name: 'emailParent', label: 'Email Parent' } 
                  ]}
                  options={{
                    filterType: "checkbox",
                    textLabels: {
