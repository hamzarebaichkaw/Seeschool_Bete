...
export default function ClassesAdmin() {
  ...
  return (
    <div >
      ...
      <Button variant="contained" color="secondary" href="http://localhost:3000/#/admin/addclasse" style={{borderRadius:'20px', letterSpacing:5,backgroundColor:'#9D0208',height:'50px'}}>
