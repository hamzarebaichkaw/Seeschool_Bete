          ...
          columns={[
            ...
            options: {
              customBodyRender: (value, tableMeta, updateValue) => {
                return (
                  <>
                   <p style={{ backgroundColor: setcolor(tableMeta.rowData["4"]), color: 'white', borderRadius: 10, textAlign: 'center' }} >{tableMeta.rowData["4"]}</p>
                  </>
                )
              }
            }
